...
export default function EditorPage() {
  ...
  const [currentUser] = useState({ name: 'Ketan', color: '#8a2be2' });
      ...
      >
        <div className="space-y-6">
           <form onSubmit={handleAddCollaborator} className="space-y-2">
              <label className="text-[10px] font-bold uppercase tracking-widest text-white/30">Invite by Email</label>
              <div className="flex gap-2">
                 <div className="relative flex-1">
                    ...
                    <input 
                       ...
                       className="w-full bg-white/5 border border-white/10 rounded-xl pl-9 pr-4 py-2.5 text-sm focus:outline-none focus:border-[#8a2be2]/50 transition-all shadow-inner"
                    />
                 </div>
                 <button className="px-4 py-2 bg-[#8a2be2] hover:bg-[#7a1bd2] rounded-xl text-sm font-bold shadow-lg shadow-[#8a2be2]/20 transition-all">
                    Invite
                 </button>
              </div>
              {collabStatus.message && (
                <p className={`text-[11px] font-medium flex items-center gap-1.5 mt-1 ${collabStatus.type === 'success' ? 'text-green-400' : collabStatus.type === 'error' ? 'text-red-400' : 'text-white/40'}`}>
                  {collabStatus.message}
                </p>
              )}
           </form>
           ...
           <div className="space-y-3">
              ...
              <div className="space-y-2 max-h-[200px] overflow-y-auto pr-2 custom-scrollbar">
                 <div className="flex items-center justify-between p-3 bg-white/5 border border-white/10 rounded-xl group hover:bg-white/[0.08] transition-all">
                    <div className="flex items-center gap-3">
                       <div className="w-8 h-8 rounded-lg bg-[#8a2be2] flex items-center justify-center text-xs font-black">K</div>
                       <div>
                          <p className="text-sm font-bold">Ketan <span className="text-[10px] font-normal text-white/30 ml-1 bg-white/10 px-1.5 py-0.5 rounded uppercase tracking-tighter">Owner</span></p>
                          <p className="text-[11px] text-white/30">ketan@codesync.io</p>
                       </div>
                    </div>
                 </div>
              </div>
